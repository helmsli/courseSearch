...
@Service("searchEByHotCourseService")
public class SearchEHotCourseServiceImpl implements SearchEByHotCourseService {
	private static final Logger LOGGER = LoggerFactory.getLogger(SearchEHotCourseServiceImpl.class);
	...
	@Autowired
	private HotCourseRecommSearchRepository courseEByDefaultRepository;

	@Override
	public String saveCourse(HotCourseRecommend course) {
		HotCourseRecommend ret = courseEByDefaultRepository.save(course);
	...
	@Override
	public HotCourseRecommend findOne(String courseId) {
	...
	protected ProcessResult searchCourseByArray(String searchContentArray[], QueryPageRequest queryPageRequest) {
			...
			lists[0]=new FilterFunctionBuilder(queryBuilder,
	    	  ...
	    	  FunctionScoreQueryBuilder functionScoreQueryBuilder = new FunctionScoreQueryBuilder(queryBuilder,lists);
		        ...
		        Page<HotCourseRecommend> searchPageResults = courseEByDefaultRepository.search(searchQuery);
