...
public class AspectLog {
  ...
  @Pointcut("execution(public * com.company.elasticsearch.service..*.*(..)) ||  execution(public * com.company.elasticsearch.controller.rest..*.*(..)) || execution(public * com.company.courseManager.fastDfs..*.*(..)) || execution(public * com.company.coursestudent..*.*(..))")
